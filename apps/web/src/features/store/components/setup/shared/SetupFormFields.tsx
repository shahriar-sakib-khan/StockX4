...
export const EditableNumField = ({
  ...
  <div className="flex flex-col items-center gap-0.5 flex-1 min-w-0">
    ...
    <input
      ...
      onBlur={onBlur}
      className={`w-full text-center text-3xl font-black ${color} bg-transparent border-none outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none`}
    />
  </div>
);
...
export const EditablePriceField = ({
  ...
  <div className="flex items-center justify-between w-full px-1 gap-1">
    <span className="text-[10px] font-black text-slate-400 uppercase tracking-wide shrink-0 w-6">{label}</span>
...
export const inputCls = "w-full rounded-lg border border-input bg-background px-3 py-2.5 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-primary/40";
