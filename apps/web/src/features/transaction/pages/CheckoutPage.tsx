...
export const CheckoutPage = () => {
    const { saleItems, returnItems, getTotals, customer, clearCart, allocatedDueCylinders } = usePosStore();
            ...
            const res = await transactionApi.create(storeId, {
                ...
                dueCylinders: (allocatedDueCylinders && allocatedDueCylinders.length > 0)
                     ? allocatedDueCylinders
                          ...
                          .map(b => ({ productId: b.productId, brandName: b.brandName, quantity: b.selectedQty }))
                     : undefined
            });
