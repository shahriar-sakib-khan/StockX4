                   ...
                   <>
                       <Select value={filterSize} onValueChange={setFilterSize}>
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="12kg" className="font-bold">12kg</SelectItem>
                                <SelectItem value="35kg" className="font-bold">35kg</SelectItem>
                                <SelectItem value="45kg" className="font-bold">45kg</SelectItem>
                            </SelectContent>
                        </Select>
