...
import { User, Store, Phone, Wallet, MapPin } from 'lucide-react';
...
export const CustomerCard = ({ type, name, phone, address, ownerName, balance, isSelected, onClick }: CustomerCardProps) => {
    return (
        <div
            onClick={onClick}
            className={cn(
