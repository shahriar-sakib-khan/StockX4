      ...
      <div className="flex flex-col md:flex-row items-center justify-between bg-white border rounded-lg p-2 gap-2 shrink-0 shadow-sm h-auto md:h-14">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
              ...
              <Tabs value={activeCategory} onValueChange={(v) => setActiveCategory(v as any)} className="w-full sm:w-auto shrink-0">
                <TabsList className="grid w-full sm:w-[320px] grid-cols-3 h-[42px] bg-slate-200 p-1 rounded-lg">
                    <TabTrigger value="cylinder" className="rounded-md data-[state=active]:bg-orange-600 data-[state=active]:text-white data-[state=active]:shadow-lg transition-all font-black text-slate-700 focus-visible:ring-0">Cylinders</TabTrigger>
                    <TabTrigger value="stove" className="rounded-md data-[state=active]:bg-emerald-600 data-[state=active]:text-white data-[state=active]:shadow-lg transition-all font-black text-slate-700 focus-visible:ring-0">Stoves</TabTrigger>
                    <TabTrigger value="regulator" className="rounded-md data-[state=active]:bg-blue-600 data-[state=active]:text-white data-[state=active]:shadow-lg transition-all font-black text-slate-700 focus-visible:ring-0">Regulators</TabTrigger>
                </TabsList>
              </Tabs>
