        ...
        <Card className="overflow-hidden border-2 hover:border-primary/50 transition-all duration-300 group bg-white shadow-sm hover:shadow-md h-full flex flex-col">
            <div className="p-4 flex flex-col h-full gap-4">
                    ...
                    {isPriceMode ? (
                         <div className="border-2 border-indigo-100 rounded-lg p-2 bg-indigo-50/50 space-y-2">
                            ...
                            <div className="flex gap-2">
                                ...
                                <Button size="sm" className="flex-1 h-7 text-xs bg-indigo-600 hover:bg-indigo-700 text-white" onClick={handleSavePrices} disabled={update.isPending || isSaving}>
                                    {(update.isPending || isSaving) ? <Loader2 className="w-3 h-3 animate-spin" /> : <><Check className="w-3 h-3 mr-1" /> Save</>}
                                </Button>
                            </div>
                         </div>
                    ) : (
                ...
                <div className="flex items-center gap-2 mt-auto pt-2">
                    <Button
                        className="flex-1 bg-primary hover:bg-primary/90 text-primary-foreground font-black shadow-sm shadow-primary/30 hover:shadow-md transition-all"
                        onClick={() => onBuy(item)}
                    >
                    ...
                    <Button
                        variant="outline"
                        size="sm"
                        className="h-10 px-3 font-semibold border-emerald-200 text-emerald-700 hover:bg-emerald-50"
