...
import { Loader2, Settings, Filter, Plus } from "lucide-react";
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div className="flex items-baseline gap-1">
                                ...
                                <span className="text-muted-foreground">/</span>
                                <span className="text-xl font-bold text-destructive">{stats.size22.damaged}</span>
                            </div>
                            <p className="text-[10px] text-muted-foreground">Stock / Damaged</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div className="flex items-baseline gap-1">
                                ...
                                <span className="text-muted-foreground">/</span>
                                <span className="text-xl font-bold text-destructive">{stats.size20.damaged}</span>
                            </div>
                            <p className="text-[10px] text-muted-foreground">Stock / Damaged</p>
                        </div>
                    </div>
