    ...
    return (
        <div className="flex items-center gap-2 mt-auto pt-1 shrink-0">
            <Button
                ...
                size="sm"
                className="flex-1 h-10 text-sm font-black bg-primary hover:bg-primary/90 text-primary-foreground shadow-sm shadow-primary/30 hover:shadow-md transition-all"
            >
