...
const seedCustomers = async () => {
    try {
        ...
        // 2. Create Customers
        const customers = [
            { type: 'retail', name: 'Rahim Uddin', phone: '01700000001', address: 'Dhaka, Bangladesh' },
            { type: 'retail', name: 'Karim Mia', phone: '01700000002', address: 'Mirpur, Dhaka' },
            { type: 'wholesale', name: 'Retailer Alpha', phone: '01700000003', address: 'Gulshan, Dhaka', ownerName: 'Mr. Alpha' },
            { type: 'wholesale', name: 'Shop Beta', phone: '01700000004', address: 'Banani, Dhaka', district: 'Dhaka' },
            { type: 'retail', name: 'Customer Five', phone: '01700000005', address: 'Uttara, Dhaka' },
        ];
