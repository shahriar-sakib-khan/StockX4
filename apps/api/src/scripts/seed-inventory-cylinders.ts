                ...
                for (const variant of variantsToSeed) {
                    ...
                    if (!exists) {
                        await StoreInventory.create({
                            ...
                            prices: {
                                buyingPriceFull: variant.size === '12kg' ? 1250 : 3100,
                                retailPriceFull: variant.size === '12kg' ? 1450 : 3500,
                                wholesalePriceFull: variant.size === '12kg' ? 1350 : 3300,
                                buyingPriceGas: variant.size === '12kg' ? 900 : 2400,
                                retailPriceGas: variant.size === '12kg' ? 1100 : 2800,
                                wholesalePriceGas: variant.size === '12kg' ? 1000 : 2600
                            }
                        });
