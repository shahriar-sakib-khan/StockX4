...
// Unique product composition per store to allow same name but different models/variants
productSchema.index({ storeId: 1, name: 1, type: 1, modelNumber: 1, burnerCount: 1, size: 1 }, { unique: true });
