...
const MongoTransactionItemSchema = new Schema({
    ...
    type: { type: String, enum: ['CYLINDER', 'ACCESSORY', 'FUEL', 'REPAIR', 'GENERAL_EXPENSE', 'stove', 'regulator', 'pipe', 'accessory', 'other'], required: true },
...
const TransactionSchema = new Schema<ITransaction>({
    ...
    customerType: { type: String, enum: ['Customer', 'Vehicle'] },
