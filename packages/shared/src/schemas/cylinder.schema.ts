...
export const updateInventorySchema = z.object({
  ...
  prices: z.object({
    ...
    retailPriceFull: z.number().min(0).optional(),
    retailPriceGas: z.number().min(0).optional(),
    wholesalePriceFull: z.number().min(0).optional(),
    wholesalePriceGas: z.number().min(0).optional(),
  }).optional(),
});
